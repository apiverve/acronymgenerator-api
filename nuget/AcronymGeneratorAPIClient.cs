...
namespace APIVerve.API.AcronymGenerator
{
    ...
    /// <summary>
    /// Client for the AcronymGenerator API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/acronymgenerator";
        ...
        {
            { "text", new ValidationRule { Type = "string", Required = true, MaxLength = 200 } }
        };
        ...
        public AcronymGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AcronymGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AcronymGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AcronymGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(AcronymGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(AcronymGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AcronymGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AcronymGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AcronymGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AcronymGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AcronymGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(AcronymGeneratorQueryOptions options)
        {
