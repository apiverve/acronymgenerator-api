...
class TestAcronymgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = AcronymgeneratorAPIClient(self.api_key)

    @patch('apiverve_acronymgenerator.apiClient.requests.get')
