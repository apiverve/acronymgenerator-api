# Acronym Generator API - Examples

This folder contains example code for using the Acronym Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/acronymgenerator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/acronymgenerator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/acronymgenerator](https://docs.apiverve.com/ref/acronymgenerator)
