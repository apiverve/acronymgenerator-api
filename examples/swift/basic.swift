...
let client = AcronymGeneratorAPIClient(apiKey: "YOUR_API_KEY_HERE")

// Query parameters
let parameters: [String: Any] &#x3D; [&quot;text&quot;: &quot;Application Programming Interface&quot;]
...
Task {
    ...
    } catch let error as AcronymGeneratorAPIError {
