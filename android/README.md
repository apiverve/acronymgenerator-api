...
```gradle
dependencies {
    implementation 'com.github.apiverve:acronymgenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.acronymgenerator.AcronymGeneratorAPIClient;
import com.apiverve.acronymgenerator.APIResponse;
import com.apiverve.acronymgenerator.APIException;

// Initialize the client
AcronymGeneratorAPIClient client = new AcronymGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "Application Programming Interface");
