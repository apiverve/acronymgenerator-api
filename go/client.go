// Package acronymgenerator provides a Go client for the Acronym Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/acronymgenerator?utm_source=go&utm_medium=readme
package acronymgenerator
...
const (
	baseURL        = "https://api.apiverve.com/v1/acronymgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Acronym Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Acronym Generator API client.
...
// Execute makes a request to the Acronym Generator API with typed parameters.
//
...
//   - text (required): string - The text or phrase to generate acronyms from (max 200 characters) [maxLength: 200]
