...
namespace APIVerve\Acronymgenerator;
...
/**
 * Client for the Acronym Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/acronymgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/acronymgenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AcronymgeneratorClient] {$message}\n";
        }
    }
}
